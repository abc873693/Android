...
//	public static final int RESULT_EXTRAS_INVALID = 6002;
	...
	protected void onCreate(Bundle savedInstanceState) {
		...
		if(oCreateTrade.getEnvironment() == null){
			Log.e(Utility.LOGTAG, "PaymentActivity -> EXTRA_PAYMENT's Environment is null");
		...
		try {
			...
			Log.e(Utility.LOGTAG, "PaymentActivity -> receive error : " + e.getMessage());

...
public class HomeFragment extends Fragment {
    ...
    public View onCreateView(LayoutInflater inflater, ViewGroup container, Bundle savedInstanceState) {
        ...
        Log.e("HomeFragment", "onCreateView" + getArguments().getInt(ARG_SECTION_NUMBER));
    ...
    public void onResume() {
        super.onResume();
        Log.e("HomeFragment", "onResume" + getArguments().getInt(ARG_SECTION_NUMBER));
    }

    @Override
    public void onPause() {
        super.onPause();
        Log.e("HomeFragment", "onPause" + getArguments().getInt(ARG_SECTION_NUMBER));

...
public class TATDB {
    ...
    // 建立範例資料
    public void sample() {
        TATItem item = new TATItem("1", new Date().getTime());
        TATItem item2 = new TATItem("2", new Date().getTime());
        TATItem item3 = new TATItem("3", new Date().getTime());
